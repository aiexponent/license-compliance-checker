...
1. **Report Bugs**: Found a bug? [Open an issue](https://github.com/aiexponent/license-compliance-checker/issues/new)
2. **Suggest Features**: Have an idea? [Start a discussion](https://github.com/aiexponent/license-compliance-checker/discussions)
...
Look for issues labeled [`good-first-issue`](https://github.com/aiexponent/license-compliance-checker/labels/good-first-issue) - these are suitable for newcomers.

### Finding Something to Work On

1. Check [open issues](https://github.com/aiexponent/license-compliance-checker/issues)
2. Look at [the roadmap](https://github.com/aiexponent/license-compliance-checker/projects)
3. Browse [discussions](https://github.com/aiexponent/license-compliance-checker/discussions)
...
7. **Create a Pull Request**:
   - Go to https://github.com/aiexponent/license-compliance-checker/pulls
...
2. Search [existing issues](https://github.com/aiexponent/license-compliance-checker/issues)
3. Ask in [discussions](https://github.com/aiexponent/license-compliance-checker/discussions)
...
Questions? Email support@lcc.dev or open a [discussion](https://github.com/aiexponent/license-compliance-checker/discussions).
